...
import com.desu.gengi.goldperman.ui.activity.RecordActivity;
import com.desu.gengi.goldperman.ui.adapter.DraggableGridExampleAdapter;
...
//            mRecyclerView.addItemDecoration(new ItemShadowDecorator((NinePatchDrawable) ContextCompat.getDrawable(getContext(), R.drawable.shadow)));
        }
...
//        animator.setMoveDuration(2000);
    ...
    public AbstractDataProvider getDataProvider() {
        return ((RecordActivity) getActivity()).getDataProvider();
    }
}
